  ...
  return (
    <section className="bg-white py-24 w-full overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="relative w-full py-40 flex flex-col items-center justify-center overflow-hidden">
            {/* Background Text Overlay */}
            <div className="absolute inset-0 flex items-center justify-between pointer-events-none px-4 md:px-20 lg:px-40">
                <div className="text-[128px] font-bold text-[#eff4ff] opacity-100 select-none transform translate-x-[-120px] transition-transform duration-1000 group-hover:translate-x-0">
                    VARIETY
                </div>
                <div className="text-[128px] font-bold text-[#eff4ff] opacity-100 select-none transform translate-x-[120px] transition-transform duration-1000 group-hover:translate-x-0">
                    FEATURES
